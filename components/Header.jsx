    ...
    <header className="sticky top-0 z-40 bg-white border-b shadow-sm">
      <div className="page-container flex items-center gap-3 sm:gap-6 py-2 md:py-3">
        ...
        <div className="flex items-center gap-3 md:gap-5 ml-auto flex-shrink-0">
          ...
          <Link
            href="/search"
            className="hidden sm:flex flex-col items-center w-8 h-8 md:w-10 md:h-10"
          >
            <Search size={20} />
          ...
          <Link
            href="/wishlist"
            className="relative flex flex-col items-center w-8 h-8 md:w-10 md:h-10"
          >
            <Heart size={20} />
            {wishCount > 0 && (
            ...
            <span className="text-[9px] md:text-[10px] mt-0.5 hidden sm:block">
              Wishlist
            </span>
          </Link>
          ...
          <Link
            href="/profile"
            className="flex flex-col items-center w-8 h-8 md:w-10 md:h-10"
          >
            <User size={20} />
            <span className="text-[9px] md:text-[10px] mt-0.5 hidden sm:block">
              Account
