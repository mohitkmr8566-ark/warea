...
// ✅ Lazy-load only required Recharts components — no SSR
...
export default function AdminDashboard() {
  ...
  const stats = useMemo(() => {
    ...
    orders.forEach((o) => {
      ...
      let dt = o.createdAt?.toDate
        ? o.createdAt.toDate()
        : new Date(o.createdAt?.seconds ? o.createdAt.seconds * 1000 : o.createdAt || Date.now());
    ...
    return { ...s, dailySalesArray, topProductsArray };
  }, [orders]);

  if (loading || fetching) {
    return (
      <div className="page-container py-12 text-center text-gray-500">
              ...
              <div key={o.id} className="flex justify-between items-center border rounded p-3">
                <div>
                  <div className="font-semibold">
                    <a href={`/order/${o.id}`} className="text-blue-600 hover:underline">
