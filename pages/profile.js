        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <aside className="md:col-span-1 bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-sm text-gray-700">
              <p>Name: <strong>Guest User</strong></p>
              <p className="mt-1">Email: <strong>guest@warea.local</strong></p>
            </div>
          </aside>
          ...
          <section className="md:col-span-2 space-y-6">
            <div className="bg-white p-4 rounded-lg shadow">
              ...
              <p className="text-sm text-gray-500">No orders yet. Orders will appear here once you complete a checkout.</p>
            </div>
